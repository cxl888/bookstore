...
import static com.laver.bookstore.util.Constant.DONATE_CONTRIBUTION;
import static com.laver.bookstore.util.Constant.SELL_CONTRIBUTION;
...
public class UserService implements IUserService{
	...
	@Override
	public int addContribution(String uname) {
		User user = userMapper.selectByName(uname);
		user.setContribution(user.getContribution()+SELL_CONTRIBUTION);
		System.out.println(user.getContribution());
		return userMapper.updateByPrimaryKeySelective(user);
	}

	@Override
	public int donateContribution(String uanme) {
		User user = userMapper.selectByName(uanme);
		user.setContribution(user.getContribution()+DONATE_CONTRIBUTION);
		System.out.println(user.getContribution());
		return userMapper.updateByPrimaryKeySelective(user);
	}
}

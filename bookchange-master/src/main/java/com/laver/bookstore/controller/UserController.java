...
public class UserController {
	...
	public String myBook(Model model,Integer uid,Integer pageNum,HttpSession session){
		User sessionUser= (User) session.getAttribute("user");
		User user= (User) userService.findUserById(sessionUser.getUid());
		...
		List<Book> books= bookService.findBookProvider(user.getUname());

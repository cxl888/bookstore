            ...
            <form action="shopping-result.html">
                <table class="table table-hover">
                    ...
                    <c:forEach var="good" items="${sessionScope.cart.goods}">
                        <tr id="product_id_1">
                            <td class="number"><img height="80" width="80"
                            ...
                            <td class="price">
                                ...
                                <input id="price${good.key.bid}" type="hidden" value="${good.key.provider}"/>
                            </td>
                            <td class="number">
                                ...
                                <input id="ordernum${good.key.bid}" name="ordernum" type="hidden" value="${good.value}"/>

	...
	<div id="product" class="main">
		...
		<div class="infos">
			...
			<div class="buy">
				...
				<p>借阅数量：<span id="sub" onclick="subNum();"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></span>&nbsp;
				...
				<c:if test="${book.store>0}">
					...
					<a id="buy" href="#"><img class="buyBtn" src="<%=basePath %>images/buy.jpg"></a>&nbsp;&nbsp;&nbsp;
				<input type="hidden" id="bid" value="${book.bid}"  />&nbsp;&nbsp;&nbsp;
				<a id="submit" href="#"><img src="<%=basePath %>images/cart.png"></a>
				</c:if>
				<c:if test="${book.store==0}">
					<img src="<%=basePath %>images/null.png">
				</c:if>
				</div>
			</div>
			<div class="clear"></div>
		...
		<div class="guestbook">
			...
			<div class="pager">
				...
				<c:if test="${comments.size()==0}">
					<div class="introduce">
						<div class="text">该图书还没有人写评价呢~</div>
					</div>
				</c:if>
			</div>
	</div>

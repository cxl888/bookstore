...
<div class="main">
	...
	<div class="manage">
		<form action="modifyBook.do" method="post">
			...
			<table class="form">
				<tr>
					<td class="field">图书名称：</td>
					<td><input type="text" class="text" name="bname" value="${book.bname }" /></td>
				</tr>
				<tr>
					<td class="field">图书简介：</td>
					<td><input type="text" class="text" name="detail" value="${book.detail }" /></td>
				</tr>
				<tr>
					<td class="field">图书定价：</td>
					<td><input type="text" class="text tiny" name="pirce" value="${book.pirce}"/> 元</td>
				</tr>
				<tr>
					...
					<td>
						<select name="type" class="form-control"  style="width: 90px;" >
							...
							<option value="${bt}"<c:if test="${bt==book.type}">selected="selected"</c:if> >${bt}</option>
							</c:forEach>
						</select>
					</td>
				</tr>

...
<h3> </h3>
<div class="infos">
    <div class="thumb"><img height="300" width="300" src="<%=basePath %>images/product/${donate.image}" /></div>
    <div class="buy">
        <p>官方定价：<span class="price">￥${donate.price}</span></p>
        <p>作 者：${donate.writer}</p>
        <p>出版社：${donate.printer}</p>
        <p>出版日期：${donate.date}</p>
        <p>捐赠人：${donate.donater}</p>
    </div>
    <div class="clear"></div>
</div>
<div class="introduce">
